nonpara_X_timevarying_S_timevarying <- function(lme_df_miss,
                                                para_ini,
                                                X.cont = TRUE, 
                                                aux.cont = TRUE){
  ...
  loglik.nlme <- function(para){
    ...
    likcontri_nonv <- logliknonvalidXvaryauxinv(Y_miss_wide[V,], Y_miss_wide[V_nonv,], X_miss_wide[V,], X_miss_wide[V_nonv,], Z_wide[V_nonv,],
                                                X_aux_wide[V,], X_aux_wide[V_nonv,], theta.vec, Sigma.mat, H)
